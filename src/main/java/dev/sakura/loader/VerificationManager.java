...
public class VerificationManager {
    ...
    public boolean hasValidJarData() {
        ...
        if (receivedJarBytes == null || receivedJarBytes.length < 100) {
            System.err.println("[Sakura] Invalid JAR data: null or too small (" + (receivedJarBytes == null ? "null" : receivedJarBytes.length) + ")");
            return false;
        }
        ...
        if (receivedJarBytes[0] != 0x50 || receivedJarBytes[1] != 0x4B ||
            ...
            System.err.println(String.format("[Sakura] Invalid JAR magic: %02X %02X %02X %02X",
                    receivedJarBytes[0], receivedJarBytes[1], receivedJarBytes[2], receivedJarBytes[3]));
            return false;
        }
