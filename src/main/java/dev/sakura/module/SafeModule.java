...
public abstract class SafeModule extends Module {
    @Expose
    @SerializedName("hudX")
    protected float x;
    ...
    public SafeModule(String englishName, @Nullable String chineseName, float defaultX, float defaultY) {
    ...
    public SafeModule(String englishName, String chineseName, Category category, MinecraftClient mc, float defaultX, float defaultY) {
        super(englishName, chineseName, category);
        this.mc = mc;
        this.defaultX = defaultX;
        this.defaultY = defaultY;
    }
